...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#000066" Height="261px" Width="302px">
            ...
            <asp:Button ID="Button1" runat="server" BackColor="#6600FF" Font-Size="Medium" ForeColor="White" style="top: 189px; left: 49px; position: absolute; height: 42px; width: 213px" Text="Contra Maquina" OnClick="Button1_Click" />
